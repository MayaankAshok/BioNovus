...
import { ExtractContentTypeFromConfig, FileErrors, SelectedFiles, SelectedFilesOrErrors, UseFilePickerConfig } from '../interfaces';
export declare abstract class Validator<CustomErrors = unknown, ConfigType extends UseFilePickerConfig<CustomErrors> = UseFilePickerConfig<any>> {
     ...
     */
    onFilesSelected(_data: SelectedFilesOrErrors<ExtractContentTypeFromConfig<ConfigType>, CustomErrors>): Promise<void> | void;
    /**
