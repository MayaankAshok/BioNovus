...
export type UseFilePickerError<CustomErrors = unknown> = CustomErrors extends {} ? BaseErrors | CustomErrors : BaseErrors;
...
export interface ImageDimensionError {
    ...
    causedByFile: FileWithPath;
    reasons: ('IMAGE_WIDTH_TOO_BIG' | 'IMAGE_WIDTH_TOO_SMALL' | 'IMAGE_HEIGHT_TOO_BIG' | 'IMAGE_HEIGHT_TOO_SMALL' | 'IMAGE_NOT_LOADED')[];
}
...
export type SelectedFilesOrErrors<ContentType, CustomErrors = unknown> = XOR<SelectedFiles<ContentType>, FileErrors<CustomErrors>>;
...
export type ExtractContentTypeFromConfig<Config> = Config extends {
    readAs: 'ArrayBuffer';
} ? ArrayBuffer : string;
export type UseFilePickerConfig<CustomErrors = unknown> = UseFilePickerConfigCommon & ReadFileContentConfig<CustomErrors>;
...
export type ImperativeFilePickerReturnTypes<ContentType, CustomErrors = unknown> = FilePickerReturnTypes<ContentType, CustomErrors> & {
